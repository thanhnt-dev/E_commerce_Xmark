...
import com.thanhnt.productservice.application.service.CloudinaryService;
import com.thanhnt.productservice.infrastructure.config.CloudinaryConfig;
...
public class CloudinaryServiceImpl implements CloudinaryService {
  ...
  public Map<String, String> uploadImage(byte[] image) {
    var params =
        ObjectUtils.asMap(
            "folder", "eCommerce/product_information",
            "resource_type", "image");
    try {

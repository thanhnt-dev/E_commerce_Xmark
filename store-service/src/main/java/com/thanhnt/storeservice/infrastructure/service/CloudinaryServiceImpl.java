...
import com.thanhnt.storeservice.application.service.CloudinaryService;
import com.thanhnt.storeservice.infrastructure.config.CloudinaryConfig;
...
public class CloudinaryServiceImpl implements CloudinaryService {
  ...
  public Map<String, String> uploadImage(byte[] image) {
    var params =
        ObjectUtils.asMap(
            "folder", "eCommerce/store_information",
            "resource_type", "image");
    try {

...
import com.thanhnt.storeservice.application.service.UserServiceFeign;
...
public class AuthenticationTokenFilter extends OncePerRequestFilter {
  ...
  private final List<String> PUBLIC_URLS =
      List.of("/swagger-ui/", "/v3/api-docs/", "/v3/api-docs/store-service", "/actuator/health");
  private final List<String> INTERNAL_API =
      List.of(
          "/api/v1/stores/valid-store/", "/api/v1/stores/add_product_shop", "/api/v1/stores/info/");
  private final List<String> PUBLIC_PRODUCT_ENDPOINTS = List.of("/api/v1/**");
  ...
  protected void doFilterInternal(
    ...
    var isPublicProductEndpoint = PUBLIC_PRODUCT_ENDPOINTS.stream().anyMatch(requestUri::contains);
